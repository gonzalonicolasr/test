...
const textPass = (input) => {
  ...
  if (!validPass(input)) {
    hayError(
        input,
        "Este campo es necesario que tenga por lo menos 8 caracteres, una letra mayuscula, una letra minuscula, un numero y un simbolo."
    );
    return;
  }
...
const formValid = (e) => {
  ...
  let validacionDeForm =
      validName && validLastName && validEmail2 && validPhone2 && validPass2;
